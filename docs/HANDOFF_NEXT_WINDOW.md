...
README, PUBLICATION, KNOWN-ISSUES, AGENTS and the historical private-layout/data/pipeline/security documents now state their applicable scope. `PUBLIC_SECURITY_PRIVACY_STATUS.md` summarizes the public/private boundary and explicitly lists work requiring a new independent security and privacy audit. Documentation changes were prepared in the isolated `.wuwa-description-sync-20260923` clone and synchronized to the public checkout. README links to docs and examples omitted from the basic portable package now lead to the public repository. Final beta.6 source/tag commit: `17f5c08b083b3976c5f5f699d895ac92979fd156`; main CI `35878189570` and tag CI `35878560984` both succeeded. GitHub Release `v0.2.0-beta.6` is public with ZIP and `.sha256` assets. The ZIP is 74,139,279 bytes and its verified GitHub digest is `sha256:594ff252ae105a40f85fffd9d3e499d7b54fe119f307ec139b496e1cd370546e`. The release was built from that final commit; subsequent handoff-only documentation commits may leave main ahead of the tag. This is not a comprehensive security/privacy audit; the next task should conduct one. The original private repository, its uncommitted changes and protected files remain untouched.
